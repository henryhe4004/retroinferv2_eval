...
DATASET_STEM="${DATASET_STEM:-Qwen2.5-14B-Instruct-1M}"
...
LOG_DIR="${LOG_DIR:-${SCRIPT_DIR}/Qwen2.5-14B-Instruct-1M-retroinfer-batchsize-logs-nsys${NSYS_PROFILE}-cache${CACHE}-policy${CACHE_POLICY}-cudagraph${USE_CUDA_GRAPH}}"
NSYS_HAS_SAMPLE=0
NSYS_HAS_CPUCTXSW=0
