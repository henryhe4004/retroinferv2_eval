...
DATA_DIR="${DATA_DIR:-/jhe/RetrievalAttention/throughput_eval/data}"
...
SEQ_LIST="${SEQ_LIST:-4 8 16 32 64 128 256}"  #8 16 32 64 128 256
BSZ_LIST="${BSZ_LIST:-1}"
...
LOG_DIR="${LOG_DIR:-${SCRIPT_DIR}/Llama-3-8B-Instruct-Gradient-1048k-retroinfer-seqlen-logs-nsys${NSYS_PROFILE}-cache${CACHE}-policy${CACHE_POLICY}-cudagraph${USE_CUDA_GRAPH}}"
NSYS_HAS_SAMPLE=0
NSYS_HAS_CPUCTXSW=0
